  ...
  function Carousel() {
    return (
      <Flickity className= "lg:container mx-auto mt-[20px] sm:mt-[60px]">
        <div className={`w-full h-[307px]  sm:h-[420px] bg-center bg-cover flex justify-between gap-9 lg:gap-0 flex-row-reverse xs:flex-row items-center lg:px-4 px-3`} style={{ backgroundImage: `url(${`./photos/h1.jpg`})` }}>
          ...
          <img src={`./photos/h2.jpg`} alt="Пеноплекс" className=" object-contain w-[150px] h-[151px] sm:h-[391px] sm:w-[317px]" />
        </div>
        <div className={` w-full h-[307px] sm:h-[420px] bg-center bg-cover flex justify-between gap-9 lg:gap-0 flex-row-reverse xs:flex-row items-center lg:px-4 px-3`} style={{ backgroundImage:  ` url(${`./photos/h3.jpg`})`, objectFit: "cover" }}>
          <div className=" flex-1">
          ...
          <img src={`./photos/h3.jpg`} alt="Пеноплекс" className=" object-contain w-[150px] h-[151px] sm:h-[391px] sm:w-[317px]" />
        </div>

        <div className={`w-full h-[307px]  sm:h-[420px] bg-center bg-cover flex justify-between gap-9 lg:gap-0 flex-row-reverse xs:flex-row items-center lg:px-4 px-3`} style={{ backgroundImage: `url(${`./photos/h5.jpg`})` }}>
          <div className=" flex-1">
          ...
          <div className=" flex justify-center items-center flex-col  relative">
            <img src={`./photos/h6.jpg`} alt="Пеноплекс" className=" sm:absolute  sm:top-32 object-contain w-[220px] h-[251px] sm:h-[391px] sm:w-[317px]" />
            <img src={`./photos/h7.jpg`} alt="Пеноплекс" className=" hidden  sm:block object-contain w-[120px] h-[151px] sm:h-[391px] sm:w-[317px]" />
          </div>
        </div>
        <div className={`w-full h-[307px]  sm:h-[420px] bg-center bg-cover flex justify-between gap-9 lg:gap-0 flex-row-reverse xs:flex-row items-center lg:px-4 px-3`} style={{ backgroundImage: `url(${`./photos/h8.jpg`})` }}>
          <div className=" flex-1">
          ...
          <img src={`./photos/h9.jpg`} alt="Пеноплекс" className=" object-contain w-[10p5x] h-[151px] sm:h-[391px] sm:w-[317px]" />
        </div>
      </Flickity>
    );
  }
